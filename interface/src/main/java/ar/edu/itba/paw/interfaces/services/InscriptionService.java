...
public interface InscriptionService {
    ...
    Validation changeUserStateInChanga(long userId, long changaId, InscriptionState state, long loggedUser);
    Validation changeUserStateInChanga(Inscription insc, InscriptionState state, long loggedUser);
