...
//    private PawUserDetailsService userDetailsService;
    ...
    //TODO: corregir url implementar userDetailService
    @Override
...
//                .and().rememberMe().rememberMeParameter("j_rememberme").userDetailsService(userDetailsService).key("mysupersecretketthatnobodyknowsabout")
